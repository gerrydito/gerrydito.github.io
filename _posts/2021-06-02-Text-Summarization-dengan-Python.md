---
layout: post
title: Text Summarization dengan Python
...
<title>Text-Summarization-dengan-Python</title><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
...
<p>Pada tutorial ini, kita akan melakukan text summarization dalam Bahasa Indonesia dan Inggris dengan metode <strong>ekstraksi teks</strong>. Berikut adalah text yang digunakan untuk summary</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Di bawah ini merupakan contoh teks berita dari Kompas yang akan di ringkas.</p>
<p>Artikel ini telah tayang di Kompas.com dengan judul "KPK Pastikan Besok Lantik 1.271 Pegawai Jadi ASN",
<br>
Klik untuk baca: <a href="https://nasional.kompas.com/read/2021/05/31/22212671/kpk-pastikan-besok-lantik-1271-pegawai-jadi-asn?page=all">https://nasional.kompas.com/read/2021/05/31/22212671/kpk-pastikan-besok-lantik-1271-pegawai-jadi-asn?page=all</a>.
<br>
Penulis : Irfan Kamil
<br>
Editor : Dani Prabowo</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">len</span><span class="p">(</span><span class="n">teks</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">text</span><span class="o">=</span><span class="s2">&quot;&quot;&quot;A vaccine for the coronavirus will likely be ready by early 2021 but rolling it out safely across India’s 1.3 billion people will be the country’s biggest challenge in fighting its surging epidemic, a leading vaccine scientist told Bloomberg.</span>
<span class="s2">India, which is host to some of the front-runner vaccine clinical trials, currently has no local infrastructure in place to go beyond immunizing babies and pregnant women, said Gagandeep Kang, professor of microbiology at the Vellore-based Christian Medical College and a member of the WHO’s Global Advisory Committee on Vaccine Safety.</span>
<span class="s2">The timing of the vaccine is a contentious subject around the world. In the U.S., President Donald Trump has contradicted a top administration health expert by saying a vaccine would be available by October. In India, Prime Minister Narendra Modi’s government had promised an indigenous vaccine as early as mid-August, a claim the government and its apex medical research body has since walked back.</span>
<span class="s2">&quot;&quot;&quot;</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Menggunakan-package-sumy">Menggunakan package <code>sumy</code><a class="anchor-link" href="#Menggunakan-package-sumy">&#182;</a></h2>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Package <code>sumy</code> berisi berbagai metode untuk melakukan text summarizer.  Pada tutorial ini kita akan menggunakan metode text summarizer <strong>Text Rank Sumarizer</strong>. Untuk lebih lebgkap bisa mengunjungi website <a href="https://pypi.org/project/sumy/">https://pypi.org/project/sumy/</a></p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Packagae sumy hanya bisa digunakan untuk meringkas teks dalam bahasa inggris saja.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Silahkan install sumy dengan cara berikut</p>

</div>
</div>
</div>! pip install sumy
<div class="cell border-box-sizing code_cell rendered">
<div class="input">
<div class="prompt input_prompt">In&nbsp;[34]:</div>
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="kn">from</span> <span class="nn">sumy.parsers.plaintext</span> <span class="kn">import</span> <span class="n">PlaintextParser</span>
<span class="kn">from</span> <span class="nn">sumy.nlp.tokenizers</span> <span class="kn">import</span> <span class="n">Tokenizer</span>
<span class="kn">from</span> <span class="nn">sumy.summarizers.text_rank</span> <span class="kn">import</span> <span class="n">TextRankSummarizer</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># For Strings</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Summarize using sumy TextRank</span>
<span class="n">summarizer</span> <span class="o">=</span> <span class="n">TextRankSummarizer</span><span class="p">()</span>
<span class="n">summary</span> <span class="o">=</span><span class="n">summarizer</span><span class="p">(</span><span class="n">parser</span><span class="o">.</span><span class="n">document</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span>
<span class="n">text_summary</span><span class="o">=</span><span class="s2">&quot;&quot;</span>
<span class="k">for</span> <span class="n">sentence</span> <span class="ow">in</span> <span class="n">summary</span><span class="p">:</span>
    <span class="n">text_summary</span><span class="o">+=</span><span class="nb">str</span><span class="p">(</span><span class="n">sentence</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">text_summary</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">len</span><span class="p">(</span><span class="n">text_summary</span><span class="p">)</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Manual">Manual<a class="anchor-link" href="#Manual">&#182;</a></h2>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Selanjutnya, jika kita ingin meringkas teks dalam bahasa indonesia, kita perlu membuat <code>summarizer</code> sendiri karena saat ini di python belum ada package yang mumpuni dalam hal ini</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Step 1: The first step is to import the required libraries. There are two NLTK libraries that are necessary for building an efficient text summarizer.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Step 2: Remove the Stop Words and store them in a separate array of words.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Step 3: We can then create a frequency table of the words.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">stopwords</span> <span class="o">=</span> <span class="nb">set</span> <span class="p">(</span><span class="n">stopwords</span><span class="o">.</span><span class="n">words</span><span class="p">(</span><span class="s2">&quot;indonesian&quot;</span><span class="p">))</span>
<span class="n">words</span> <span class="o">=</span> <span class="n">word_tokenize</span><span class="p">(</span><span class="n">teks</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">freqTable</span> <span class="o">=</span> <span class="nb">dict</span><span class="p">()</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Step 4: Depending on the words it contains and the frequency table, we will assign a score to each sentence.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Creatinng a dictianary to keep the score</span>
<span class="n">sentences</span> <span class="o">=</span> <span class="n">sent_tokenize</span><span class="p">(</span><span class="n">teks</span><span class="p">)</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Step 5: To compare the sentences within the text, assign a score.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">sumValues</span> <span class="o">=</span> <span class="mi">0</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">average</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">average</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="n">sumValues</span> <span class="o">/</span> <span class="nb">len</span><span class="p">(</span><span class="n">sentenceValue</span><span class="p">))</span>
<span class="n">summary</span> <span class="o">=</span> <span class="s1">&#39;&#39;</span>
<span class="k">for</span> <span class="n">sentence</span> <span class="ow">in</span> <span class="n">sentences</span><span class="p">:</span>
    <span class="k">if</span> <span class="p">(</span><span class="n">sentence</span> <span class="ow">in</span> <span class="n">sentenceValue</span><span class="p">)</span> <span class="ow">and</span> <span class="p">(</span><span class="n">sentenceValue</span><span class="p">[</span><span class="n">sentence</span><span class="p">]</span> <span class="o">&gt;</span> <span class="p">(</span><span class="n">average</span><span class="p">)):</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">len</span><span class="p">(</span><span class="n">summary</span><span class="p">)</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p><a href="https://avinashnavlani.medium.com/text-summarization-using-python-773e064377eb">Avina Shnavlani</a>
<br>
<a href="https://www.mygreatlearning.com/blog/text-summarization-in-python/#">My Great Learning</a></p>
